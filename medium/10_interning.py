...
# identity of an object, which is guaranteed to be unique for 
# the object's lifetime. For certain basic immutable data types 
# like short strings or integers, Python might reuse the memory 
